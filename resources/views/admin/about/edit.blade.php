...
@section('title','Редагування розділу про нас')
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Редагування розділу про нас :{{$abouts['description']}}</h1>
          </div><!-- /.col -->
              ...
              <form action="{{route('abouts.update', $abouts['id'])}}" method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" name="alt_name" value="{{$abouts['alt_name']}}" class="form-control" id="text" placeholder="Description" required>
                     </div>

                  <div class="form-group">
                        <label for="feature_image">Додати зображення</label>
                        <input type="text" name="url" value="{{$abouts['url']}}" id="feature_image"class="form-control" name="feature_image" value="" readonly>
                        <img src="{{$abouts['url']}}" alt=""  class="img-uploaded" > 
